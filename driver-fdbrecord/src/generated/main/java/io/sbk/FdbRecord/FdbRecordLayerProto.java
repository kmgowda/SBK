  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        io.sbk.FdbRecord.FdbRecordLayerProto.Record parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (io.sbk.FdbRecord.FdbRecordLayerProto.Record) e.getUnfinishedMessage();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              io.sbk.FdbRecord.FdbRecordLayerProto.Record.Builder subBuilder = null;
              if (((bitField0_ & 0x00000001) != 0)) {
                subBuilder = Record_.toBuilder();
              }
              Record_ = input.readMessage(io.sbk.FdbRecord.FdbRecordLayerProto.Record.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        io.sbk.FdbRecord.FdbRecordLayerProto.UnionDescriptor parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (io.sbk.FdbRecord.FdbRecordLayerProto.UnionDescriptor) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      public Builder mergeRecord(io.sbk.FdbRecord.FdbRecordLayerProto.Record value) {
        if (RecordBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            ...
            Record_ =
              io.sbk.FdbRecord.FdbRecordLayerProto.Record.newBuilder(Record_).mergeFrom(value).buildPartial();
          } else {
            Record_ = value;
          }
          onChanged();
