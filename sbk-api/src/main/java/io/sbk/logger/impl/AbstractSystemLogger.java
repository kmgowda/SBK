...
/**
 * Shared implementation for loggers that print periodic and total benchmark results to {@code System.out}.
 *
 ...
 */
@NotThreadSafe
abstract class AbstractSystemLogger extends AbstractRWLogger {
    ...
    final public void print(int writers, int maxWriters, int readers, int maxReaders,
        ...
        print(System.currentTimeMillis(), writers, maxWriters, readers, maxReaders,
    ...
    final public void printTotal(int writers, int maxWriters, int readers, int maxReaders,
        ...
        printTotal(System.currentTimeMillis(), writers, maxWriters, readers, maxReaders,
                writeRequestBytes, writeRequestMbPerSec, writeRequestRecords, writeRequestRecordsPerSec,
