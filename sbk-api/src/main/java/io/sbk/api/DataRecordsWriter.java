...
public sealed interface DataRecordsWriter<T> extends DataWriter<T> permits Writer {
     ...
     * @param status    write status to return; {@link io.sbk.api.Status}
     * @param id        Writer id
     * @param logger   Writer requests logger
     * @return CompletableFuture completable future. null if write completed synchronously .
     * @throws IOException If an exception occurred.
     */
    CompletableFuture<?> write(DataType<T> dType, T data, int size, Time time, Status status,
     ...
     * @param status write status to return; {@link io.sbk.api.Status}
     * @param id     Writer id
     * @param logger Write requests logger
     * @throws IOException If an exception occurred.
     */
    void writeSetTime(DataType<T> dType, T data, int size, Time time, Status status,
                      int id, WriteRequestsLogger logger) throws IOException;
     ...
     * @param status      Write status to return; {@link io.sbk.api.Status}
     * @param perlChannel to call for benchmarking
     * @param logger       log write requests
     * @param  id          Writer id
     * @throws IOException If an exception occurred.
     */
    void recordWrite(DataType<T> dType, T data, int size, Time time,
                     Status status, PerlChannel perlChannel, int id, WriteRequestsLogger logger) throws IOException;
     ...
     * @throws IOException If an exception occurred.
     */
    default void RecordsWriter(Worker writer, long recordsCount, DataType<T> dType, T data, int size, Time time,
