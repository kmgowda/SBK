...
public class FileTest {
    ...
    public void testOpenAndCloseStorage() {
        ...
        try {
            ...
            ex.printStackTrace();
            fail("Open/Close Storage Failed!");
        }
    }
